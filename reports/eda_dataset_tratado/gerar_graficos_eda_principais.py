...
# ============================================================
# Geração de gráficos principais da EDA
#
# Objetivo:
# - substituir gráficos automáticos muito poluídos;
# - gerar gráficos limpos para uso no TCC;
# - focar em variáveis realmente importantes para modelagem.
# ============================================================
...
def expandir_colunas_outlier(df: pd.DataFrame) -> pd.Series:
    """Expande o campo outlier_colunas para contar causas de outlier."""
...
def gerar_resumo_outliers(df: pd.DataFrame) -> None:
    """Gera um painel legivel com status, causas e localizacao dos outliers."""
...
def gerar_distribuicoes_outliers(df: pd.DataFrame) -> None:
    """Gera boxplots separados para evitar escalas misturadas."""
    if "outlier_flag" not in df.columns:
        return
...
def main() -> None:
    ...
    # ========================================================
    # 02 - Distribuição da variável-alvo
    # ========================================================
    ...
    # ========================================================
    # 03 - Média da posição final por temporada
    # ========================================================
    ...
    # ========================================================
    # 04 - Grid position x Finish position
    # ========================================================
    ...
    # ========================================================
    # 05 - Qualifying position x Finish position
    # ========================================================
    ...
    # ========================================================
    # 06 - Matriz de correlação das principais variáveis
    # ========================================================
    ...
    # ========================================================
    # 10 - Distribuição do impacto climático
    # ========================================================
    ...
    # ========================================================
    # 11 - Distribuição da complexidade de pista
    # ========================================================
    ...
    # ========================================================
    # 12 - Resumo temporal de métricas principais
    # ========================================================
