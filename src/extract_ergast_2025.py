# Extracao Ergast/Jolpica - resultados de corrida 2025.
# Saída: data/raw/ergast_2025_results.csv
...
while True:
    ...
    try:
        ...
        # se cair a conexão, espera e tenta de novo
    ...
    # pega os dados de cada piloto em cada corrida
    for race in races:
