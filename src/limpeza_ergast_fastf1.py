...
# de código FastF1 pra driver_id do Ergast - necessário pra cruzar os dois
DRIVER_CODE_TO_ID = {
    "AIT": "aitken",
    "ALB": "albon",
    "ALO": "alonso",
...
# verifica se as colunas obrigatórias estão todas presentes
...
# junta Ergast 2018-2024 com Ergast 2025
ergast = pd.concat(
...
# forca conversao numerica - as vezes vem como string
...
# filtra só a era híbrida a partir de 2018
...
# remove linhas onde as colunas-chave ou o target estao nulos
...
# cria a chave RaceID pra identificar cada piloto em cada corrida
...
# joga fora linhas duplicadas pelo RaceID
...
# grid 0 pode ser pit lane, punicao ou DNS - mantem mas marca pra analisar depois
...
# converte código do FastF1 pra driver_id do Ergast pra poder fazer o merge
...
# remove linhas sem driver_id ou sem chave de corrida
...
# converte os tempos de string/timedelta pra segundos (float)
time_columns = [
    "LapTime",
    "Sector1Time",
    "Sector2Time",
...
# agrega FastF1 pra ter 1 linha por piloto por corrida
# resume todas as voltas em métricas de corrida
fastf1_agg = (
    fastf1_laps
...
# une Ergast + FastF1 pelo RaceID - left pra manter todos os registros do Ergast
...
# separa as bases finais por periodo (ate 2024 e ate 2025)
...
# salva todos os arquivos de saida
