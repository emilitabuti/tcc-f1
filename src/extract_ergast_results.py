...
# Saída: data/raw/ergast_2018_2024.csv
...
for ano in tqdm(ANOS, desc="Temporadas"):
    ...
    while True:
        ...
        # se a api tiver travando, espera um pouco e tenta de novo
        ...
        # percorre cada corrida e cada resultado pra montar a linha
        for race in races:
        ...
        # para quando buscar tudo
        if offset >= total:
            break

# vira dataframe e salva
