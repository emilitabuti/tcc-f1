...
# dados de entrada: métricas dos folds históricos e das corridas 2026
...
def preparar_dados() -> tuple[list[str], dict[str, list[float]]]:
    ...
    # monta a lista de etapas: fold 2025 + cada round disponível de 2026
    ...
    # pega o MAE do fold 2025 pra cada modelo
    for row in folds:
    ...
    # preenche o MAE de cada round 2026
...
def gerar_svg(etapas: list[str], dados: dict[str, list[float]]) -> str:
    ...
    # calcula os limites do eixo Y automaticamente
    ...
    # começa montando o SVG - cabeçalho e estilos
    elements: list[str] = [
    ...
    # linhas horizontais de grade e labels do eixo Y
    for tick in ticks_y:
        y = y_pos(tick)
    ...
    # eixos e divisoria tracejada entre validacao historica e exploratoria
    elements.extend(
        [
    ...
    # desenha as linhas e pontos de cada modelo
...
def main() -> None:
    ...
    # se tiver Chrome ou Chromium instalado, converte o SVG pra PNG também
