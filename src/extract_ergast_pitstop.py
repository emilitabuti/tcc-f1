# Extracao Ergast/Jolpica - pit stops 2018-2025.
# Saída: data/raw/ergast_pitstop_2018_2025.csv
...
# loop por temporada e por round - a api não tem endpoint geral de pitstops
    ...
    for round_num in range(1, MAX_ROUNDS + 1):
        ...
        while True:
            ...
            if response.status_code == 429:
                # rate limit pesado aqui, espera bastante
            ...
            # round nao existe nesse ano, passa pro proximo
            if not races:
                break
            ...
            # salva parcial a cada página, só pra não perder tudo se travar
