...
Etapas:
  ...
  08  08_processar_openf1_2025.py      — Dataset 2025 isolado para walk-forward
  09  09_preparar_base_feature_engineering.py — Base FE-ready + manifest anti-leakage
...
ETAPAS = [
    ...
    {"numero": 8, "script": "08_processar_openf1_2025.py",    "descricao": "Dataset 2025 para walk-forward"},
    {"numero": 9, "script": "09_preparar_base_feature_engineering.py", "descricao": "Preparação para Feature Engineering"},
]
